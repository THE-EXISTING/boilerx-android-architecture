package com.existing.boilerx.common.base.mvvm.animation
...
import com.existing.boilerx.core.base.mvvm.view.BaseMvvmRecyclerViewActivity
...
abstract class AnimationHelperMvvmRecyclerViewActivity<VH : BaseViewHolder>
    : BaseMvvmRecyclerViewActivity<VH>() {
    ...
    override
    fun onSaveInstanceStates(outState: Bundle) {
        super.onSaveInstanceStates(outState)
