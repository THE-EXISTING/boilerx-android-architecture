...
abstract class BaseMvvmRecyclerViewFragment<VH : BaseViewHolder>
    : BaseMvvmFragment(), AdapterHelper<VH> {

    companion object {
        val TAG: String = BaseMvvmRecyclerViewFragment::class.java.simpleName
    }
    ...
    fun onSetupView(savedInstanceState: Bundle?) {
        ...
        recyclerView = setupRecyclerView()?.apply {
            this.layoutManager = this@BaseMvvmRecyclerViewFragment.layoutManager
    ...
    open fun onSetupLayoutManager(): RecyclerView.LayoutManager = DefaultLinearLayoutManager(context)
