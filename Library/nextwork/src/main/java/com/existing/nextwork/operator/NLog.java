...
public class NLog{
    ...
    public static void i( String prefix, String message ){
        if( showLog ){
            ...
            if( prefix != null && !prefix.isEmpty() ){
                Log.i( TAG, prependCallLocation( HORIZONTAL_LINE + " " + prefix ) );
                Log.i( TAG, prependCallLocation( HORIZONTAL_LINE + SINGLE_DIVIDER ) );
            }
    ...
    public static void e( String prefix, String message ){
        if( showLog ){
            ...
            if( prefix != null && !prefix.isEmpty() ){
                Log.e( TAG, prependCallLocation( HORIZONTAL_LINE + " " + prefix ) );
                Log.e( TAG, prependCallLocation( HORIZONTAL_LINE + SINGLE_DIVIDER ) );
            }
    ...
    public static void e( String serviceName, Throwable throwable ){
        if( showLog ){
            Log.e( TAG, prependCallLocation( TOP_LEFT_CORNER + DOUBLE_DIVIDER ) );
            Log.e( TAG, prependCallLocation( HORIZONTAL_LINE + " Throwable: " + throwable.getClass().getSimpleName() ) );
            Log.e( TAG, prependCallLocation( HORIZONTAL_LINE + " Message: " + throwable.getMessage() ) );
            Log.e( TAG, prependCallLocation( MIDDLE_CORNER + SINGLE_DIVIDER ) );
            Log.e( TAG, prependCallLocation( HORIZONTAL_LINE + " Service: " + serviceName ) );
            Log.e( TAG, prependCallLocation( BOTTOM_LEFT_CORNER + DOUBLE_DIVIDER ) );
        }
    }
